...
export const verticalMenuItems = [
    new Menu(1, 'CodeCamps', null, null, 'code', null, true, 0),
    new Menu(2, 'Camps', '/camps', null, 'bug_report', null, false, 1),
    new Menu(3, 'Speakers', '/speakers', null, 'perm_contact_calendar', null, false, 1),
    new Menu(4, 'Talks', '/talks', null, 'record_voice_over', null, false, 1),
    new Menu(5, 'Schedule', '/schedule', null, 'event', null, false, 1),
    new Menu(6, 'Users', '/users', null, 'supervisor_account', null, false, 0),
    new Menu(7, 'Analytics Dashboard', '/', null, 'dashboard', null, false, 0),
    new Menu(8, 'About Me', '/about-me', null, 'work', null, false, 0)
]
